...
export default function LocationsTab() {
  ...
  async function createLocation() {
    ...
    if (error) {
      ...
      setMessage("Erreur lors de la création du lieu")
      return
    }
  ...
  async function updateLocationName(locationId, value, oldName) {
    const cleanName = value.trim()

    if (!cleanName) {
      setMessage("Le nom du lieu ne peut pas être vide")
      fetchLocations()
      return
    }
    ...
    if (error) {
      ...
      setMessage("Erreur lors de la modification du lieu")
      fetchLocations()
      return
    }

    setMessage("Nom du lieu modifié ✅")
    fetchLocations()
  }
  ...
  async function deleteLocation(id) {
    ...
    if (error) {
      ...
      setMessage("Impossible de supprimer ce lieu")
      return
    }
