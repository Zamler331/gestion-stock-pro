  ...
  <div className="space-y-8">
    ...
    <div className="border-b border-slate-300">
      ...
      <div className="flex gap-6 flex-wrap">
        ...
        <TabButton label="Lieux" value="locations" activeTab={activeTab} setActiveTab={setActiveTab} />
        <TabButton label="Mouvements" value="movements" activeTab={activeTab} setActiveTab={setActiveTab} />
        <TabButton label="Analytics / Exports" value="analytics" activeTab={activeTab} setActiveTab={setActiveTab} />
